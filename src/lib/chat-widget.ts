...
(function () {
  ...
  function boot() {
    ...
    style.textContent = [
      ...
      "  background: #111318; color: #fff; font-size: 14px; font-weight: 500;",
      "  box-shadow: 0 4px 16px rgba(0,0,0,.22); transition: transform .15s ease;",
      "}",
      ".launcher:hover { transform: translateY(-1px); }",
      ".launcher:focus-visible { outline: 2px solid #111318; outline-offset: 3px; }",
      ...
      "  border: 1px solid #e6e8eb; box-shadow: 0 12px 48px rgba(0,0,0,.20); overflow: hidden;",
      "}",
      ".open .panel { display: flex; }",
      ".open .launcher { display: none; }",
      ".head { display: flex; align-items: center; gap: 10px; padding: 14px 16px; border-bottom: 1px solid #eef0f2; }",
      ".head h2 { font-size: 14px; font-weight: 600; color: #111318; }",
      ".head p { font-size: 11.5px; color: #7b8794; margin-top: 1px; }",
      ".close { margin-left: auto; background: none; border: 0; cursor: pointer; color: #97a1ad; font-size: 20px; line-height: 1; padding: 4px 6px; border-radius: 6px; }",
      ".close:hover { background: #f3f5f7; color: #111318; }",
      ...
      ".bot { align-self: flex-start; background: #f2f4f6; color: #1d2530; border-bottom-left-radius: 5px; }",
      ".me { align-self: flex-end; background: #111318; color: #fff; border-bottom-right-radius: 5px; }",
      ".typing { display: inline-flex; gap: 4px; padding: 13px; }",
      ".typing i { width: 6px; height: 6px; border-radius: 50%; background: #b6bec8; animation: b 1.1s infinite; }",
      ".typing i:nth-child(2) { animation-delay: .18s; } .typing i:nth-child(3) { animation-delay: .36s; }",
      "@keyframes b { 0%,60%,100% { opacity: .3 } 30% { opacity: 1 } }",
      ".opts { display: flex; flex-wrap: wrap; gap: 7px; padding: 0 16px 12px; }",
      ".opts button {",
      "  border: 1px solid #d8dde3; background: #fff; color: #1d2530; cursor: pointer;",
      "  padding: 8px 13px; border-radius: 999px; font-size: 13px;",
      "}",
      ".opts button:hover { border-color: #111318; background: #f7f8f9; }",
      ".bar { display: flex; gap: 8px; padding: 12px; border-top: 1px solid #eef0f2; }",
      ".bar input {",
      "  flex: 1; min-width: 0; padding: 10px 13px; border: 1px solid #d8dde3;",
      "  border-radius: 10px; font-size: 14px; color: #1d2530; background: #fff;",
      "}",
      ".bar input:focus { outline: none; border-color: #111318; }",
      ".bar button { border: 0; border-radius: 10px; background: #111318; color: #fff; padding: 0 16px; font-size: 14px; font-weight: 500; cursor: pointer; }",
      ".bar button:disabled { opacity: .45; cursor: not-allowed; }",
      ".bar[hidden] { display: none; }",
      ".note { padding: 0 16px 14px; font-size: 11.5px; color: #97a1ad; line-height: 1.5; }",
